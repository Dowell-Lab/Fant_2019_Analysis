...
setwd('/home/zach/dowell_lab/pausing_meta_analysis/out/drosophila/pca')
...
pcar$group <- c("Knockdown", "Knockdown", "Knockdown", "Control", "Control", "Control")
pcap$group <- c("Knockdown (Batch Corrected)", "Knockdown (Batch Corrected)",
                "Knockdown (Batch Corrected)",
                "Control (Batch Corrected)", "Control (Batch Corrected)",
...
ggsave(str_c("./pca_fullgene_compare.png"),
       plot = last_plot(),
       device = "png",
       height = 5,
       width = 10)
