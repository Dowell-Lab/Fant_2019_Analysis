...
fileDir=/scratch/Users/zama8258/taf1_drosophila_pro_seq_metal/output/metagene
outDir="$fileDir"

allGenes="$fileDir"/lenfilter.fpkm
topGenes="$fileDir"/topGenes.bed
middleGenes="$fileDir"/middleGenes.bed
bottomGenes="$fileDir"/bottomGenes.bed

allOut="$outDir"/metagene_all.pdf
...
sbatch metagene_custom.bash --regions="$allGenes" --outfile="$allOut"
