...
df_sense$LacI_plus_Cu1_S1_R1_001.sorted.bam <-
    tpm_normalize(df_sense, df_antisense, "LacI_plus_Cu1_S1_R1_001.sorted.bam")
df_sense$LacI_plus_Cu2_S2_R1_001.sorted.bam <-
    tpm_normalize(df_sense, df_antisense, "LacI_plus_Cu2_S2_R1_001.sorted.bam")
df_sense$LacI_plus_Cu3_S3_R1_001.sorted.bam <-
    tpm_normalize(df_sense, df_antisense, "LacI_plus_Cu3_S3_R1_001.sorted.bam")
df_sense$TAF1_plus_Cu_S4_R1_001.sorted.bam <-
    tpm_normalize(df_sense, df_antisense, "TAF1_plus_Cu_S4_R1_001.sorted.bam")
df_sense$TAF1_plus_Cu2_S5_R1_001.sorted.bam <-
    tpm_normalize(df_sense, df_antisense, "TAF1_plus_Cu2_S5_R1_001.sorted.bam")
df_sense$TAF1_plus_Cu3_S6_R1_001.sorted.bam <-
    tpm_normalize(df_sense, df_antisense, "TAF1_plus_Cu3_S6_R1_001.sorted.bam")

##  FIX TYPO
## upregulated <- df_sense %>%
##     group_by(geneid) %>%
##     summarise(c1 = sum(LacI_plus_Cu1_S1_R1_001.sorted.bam),
##               c2 = sum(LacI_plus_Cu2_S2_R1_001.sorted.bam),
##               c3 = sum(LacI_plus_Cu3_S3_R1_001.sorted.bam),
##               p1 = sum(TAF1_plus_Cu_S4_R1_001.sorted.bam),
##               p2 = sum(TAF1_plus_Cu2_S5_R1_001.sorted.bam),
##               p3 = sum(TAF1_plus_Cu3_S6_R1_001.sorted.bam)) %>%
...
df_antisense$LacI_plus_Cu1_S1_R1_001.sorted.bam <-
    tpm_normalize(df_antisense, df_sense, "LacI_plus_Cu1_S1_R1_001.sorted.bam")
df_antisense$LacI_plus_Cu2_S2_R1_001.sorted.bam <-
    tpm_normalize(df_antisense, df_sense, "LacI_plus_Cu2_S2_R1_001.sorted.bam")
df_antisense$LacI_plus_Cu3_S3_R1_001.sorted.bam <-
    tpm_normalize(df_antisense, df_sense, "LacI_plus_Cu3_S3_R1_001.sorted.bam")
df_antisense$TAF1_plus_Cu_S4_R1_001.sorted.bam <-
    tpm_normalize(df_antisense, df_sense, "TAF1_plus_Cu_S4_R1_001.sorted.bam")
df_antisense$TAF1_plus_Cu2_S5_R1_001.sorted.bam <-
    tpm_normalize(df_antisense, df_sense, "TAF1_plus_Cu2_S5_R1_001.sorted.bam")
df_antisense$TAF1_plus_Cu3_S6_R1_001.sorted.bam <-
    tpm_normalize(df_antisense, df_sense, "TAF1_plus_Cu3_S6_R1_001.sorted.bam")
